const ValueCard = ({ title, description }) => {
  return (
    <div className="bg-gray-100 rounded-xl text-black flex flex-col justify-center m-3 h-40  w-1/2 p-5 shadow-sm shadow-black">
      <div className="bg-gray-100 rounded-xl text-black flex flex-col justify-center m-3 h-40  w-1/2 p-5 shadow-sm hover:shadow-[#131313] duration-150 ease-in-out hover:scale-105">
