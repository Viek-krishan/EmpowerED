  ...
  return (
    <div>
      ...
      <section className="our_perspective">
        <div className="flex flex-col justify-center items-center bg-blue-100 rounded-xl ">
              ...
              <div>
                ...
                <div>
                  <p className="text-black font-medium p-5 border-blue-500 text-center mt-5 rounded-b-3xl rounded-t-3xl">
                    ...
                    guiding you through goal setting, identifying roadblocks,
                    and developing strategies to overcome them. <br></br>
                    They can also teach valuable life skills like time
                    management, organization, and stress management, all of
                    which contribute to increased motivation and overall
                    well-being. <br></br>So, if you're feeling stuck and lacking
                    the drive to move forward, consider seeking help from an
                    online motivation tutor they can equip you with the tools
                    and mindset to reach your full potential.
                  </p>
                </div>
                <div className="flex justify-between ml-16 mr-16 mt-8 text-black ">
                  ...
                  <div>
                    <h1 className="bg-white p-9 text-xl rounded-xl text-center shadow-sm shadow-black">
                      <h1 className=" font-bold text-[#1ad178] ">Enable</h1>{" "}
          ...
          <section className="our_values w-full">
          ...
          <section className="founding_members bg-[#0c0b1e] ">
            <div className="Founding members text-white p-6 ">
            ...
            <div className="flex items-center justify-center p-5">
              ...
              <div className="text-white  text-4xl p-5 ml-5 w-[100%] text-center tracking-wider">
                <h1>Vivek Krishan</h1>
                <h1>Kshitij Saxena</h1>
                <h1>Akanksha Sinha</h1>
                <h1>Ruchi Kumari</h1>
                <p className="text-base tracking-normal mt-10">
                  We've got this! With everyone's contributions so far, we're on
                  a fantastic track. We have all the talent and knowledge needed
                  to knock this project out of the park. Let's keep up the open
                  communication and collaboration that's our secret weapon. I'm
                  confident that by working together, we'll deliver a project
                  that's not only impressive but sets the bar high.
                </p>
              </div>
            </div>
          </section>
        </div>
        <section className="faq_button mt-10">
          <div>
